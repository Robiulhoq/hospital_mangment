...
function Doctor({ userRole }) {
  ...
  const { doctorList, editDoctorId, departmentList, tigger, setTigger } =
  ...
  const { loading, message, setMessage, hendleSaveData } = usePostrequiest(
    doctorApi,
    doctor,
    setTigger
  );
  ...
  return (
    <Wrapper>
      ...
      <Content>
        ...
        {loading || imgloading || putLoading ? (
          <Loading />
        ) : (
          <Activity>
            <Link to="/doctor/1">
              <BlueButton>Doctor List</BlueButton>
            </Link>
            <form action="">
              <TextInput
                required={true}
              ...
              <TextInput
                ...
                name="dathOfBirth"
                onChange={hendleChange}
                defaultValue={doctor.dathOfBirth}
                type="text"
                title="Dath of Birth"
              ...
              <TextInput
                ...
                title="Sex"
                options={[
                  { label: "Male", defaultValue: "Male" },
                  { label: "Female", defaultValue: "Female" },
                ]}
              />
              <TextInput
                required={true}
                name="bloudGroup"
                onChange={hendleChange}
                defaultValue={doctor.bloudGroup}
                type="radio"
                title="Bloud Group"
                options={[
              ...
              <TextInput
                ...
                title="Status"
                options={[
                  { label: "Active", defaultValue: "Active" },
                  { label: "Deactive", defaultValue: "Deactive" },
                ]}
              />
              <GreenButton
                onClick={editDoctorId ? hendleEdit : hendleImageUpload}
              >
                Save
              </GreenButton>
            </form>
