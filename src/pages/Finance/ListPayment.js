                        ...
                        </tr>
                        {
                            paymentList ? paymentList.map((item, index )=> (
                                <tr>
                                    ...
                                    <td>{item.date}</td>
                                    <td>{item.payTo}</td>
                                    <td><Link to='/finance/4'><BiEdit onClick={()=> hendleEditPayment(item._id)} size='1.5rem' color='darkblue' /> </Link> 
                                    <AiFillDelete onClick={()=>hendleDeletePayment(item._id)} color='red' size='1.5rem' /></td>
                                </tr>
                            )) : null
                       }
